...
public class BaseFormController implements ServletContextAware {
     ...
     * @param player the user to send a message to.
     * @param msg the message to send.
     * @param url the URL of the application.
     */
    protected void sendUserMessage(Player player, String msg, String url) {
        if (log.isDebugEnabled()) {
            log.debug("sending e-mail to user [" + player.getEmail() + "]...");
        }

        message.setTo(player.getFullName() + "<" + player.getEmail() + ">");
        ...
        model.put("validateURL", "http://www.mtzik.fr/validateUser?key="+player.getPasswordHint());
